"""
Mock chart data for demo/development.
Returns realistic-looking HD chart results without running the real calculator.
"""
...
MOCK_CHART_RESPONSE = {
    "graph": {
        ...
        "gates": [
            {"gate": 6, "center": "solar_plexus", "color": "personality", "activated_by": [{"side": "personality", "planet": "sun", "line": 4}]},
            {"gate": 7, "center": "g", "color": "design", "activated_by": [{"side": "design", "planet": "moon", "line": 2}]},
            {"gate": 13, "center": "g", "color": "personality", "activated_by": [{"side": "personality", "planet": "earth", "line": 1}]},
            {"gate": 20, "center": "throat", "color": "both", "activated_by": [
                {"side": "personality", "planet": "mercury", "line": 3},
                {"side": "design", "planet": "sun", "line": 5}
            ]},
            {"gate": 31, "center": "throat", "color": "design", "activated_by": [{"side": "design", "planet": "venus", "line": 1}]},
            {"gate": 34, "center": "sacral", "color": "design", "activated_by": [{"side": "design", "planet": "mars", "line": 6}]},
            {"gate": 59, "center": "sacral", "color": "personality", "activated_by": [{"side": "personality", "planet": "venus", "line": 2}]},
        ],
        "meta": {
            "type": "Generator",
            "profile": "4/6",
    ...
    "words": {
        ...
        "gate_infos": [
            {"gate": 6, "name_zh": "冲突之门", "name_en": "Gate of Friction", "center": "solar_plexus", "keynote": "情绪的平衡与摩擦", "activated_by": [{"side": "personality", "planet": "sun", "line": 4}]},
            {"gate": 7, "name_zh": "军队之门", "name_en": "Gate of The Role of the Self", "center": "g", "keynote": "在互动中的自我角色", "activated_by": [{"side": "design", "planet": "moon", "line": 2}]},
            {"gate": 20, "name_zh": "当下之门", "name_en": "Gate of The Now", "center": "throat", "keynote": "当下的觉知与表达", "activated_by": [{"side": "personality", "planet": "mercury", "line": 3}, {"side": "design", "planet": "sun", "line": 5}]},
            {"gate": 31, "name_zh": "影响力之门", "name_en": "Gate of Influence", "center": "throat", "keynote": "通过领导产生影响", "activated_by": [{"side": "design", "planet": "venus", "line": 1}]},
            {"gate": 34, "name_zh": "力量之门", "name_en": "Gate of Power", "center": "sacral", "keynote": "强大的回应力量", "activated_by": [{"side": "design", "planet": "mars", "line": 6}]},
            {"gate": 59, "name_zh": "分散之门", "name_en": "Gate of Sexuality", "center": "sacral", "keynote": "打破障碍的能量", "activated_by": [{"side": "personality", "planet": "venus", "line": 2}]},
        ],
    },
}
