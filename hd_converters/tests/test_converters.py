...
def _make_sample_output() -> CalculatorOutput:
    ...
    return CalculatorOutput(
        ...
        variables={
            "digestion":   {"arrow": "Left",  "color": 4, "tone": 2},
            "environment": {"arrow": "Right", "color": 3, "tone": 5},
            "motivation":  {"arrow": "Left",  "color": 3, "tone": 1},
            "perspective": {"arrow": "Right", "color": 5, "tone": 4},
        },
        personality_activations=[
            {"planet": "sun", "gate": 13, "line": 4, "color": 2, "tone": 3, "base": 1, "longitude": 100.0},
            {"planet": "earth", "gate": 7, "line": 4, "color": 5, "tone": 1, "base": 4, "longitude": 280.0},
            {"planet": "north_node", "gate": 10, "line": 3, "color": 3, "tone": 1, "base": 2, "longitude": 200.0},
            {"planet": "south_node", "gate": 15, "line": 3, "color": 4, "tone": 6, "base": 3, "longitude": 20.0},
            {"planet": "moon", "gate": 20, "line": 5, "color": 1, "tone": 2, "base": 5, "longitude": 50.0},
            {"planet": "mercury", "gate": 34, "line": 2, "color": 6, "tone": 4, "base": 1, "longitude": 150.0},
            {"planet": "venus", "gate": 1, "line": 1, "color": 2, "tone": 5, "base": 3, "longitude": 250.0},
            {"planet": "mars", "gate": 43, "line": 6, "color": 3, "tone": 3, "base": 2, "longitude": 300.0},
            {"planet": "jupiter", "gate": 8, "line": 3, "color": 1, "tone": 1, "base": 4, "longitude": 45.0},
            {"planet": "saturn", "gate": 23, "line": 2, "color": 4, "tone": 2, "base": 1, "longitude": 60.0},
            {"planet": "uranus", "gate": 2, "line": 4, "color": 5, "tone": 6, "base": 5, "longitude": 190.0},
            {"planet": "neptune", "gate": 57, "line": 1, "color": 2, "tone": 3, "base": 2, "longitude": 270.0},
            {"planet": "pluto", "gate": 46, "line": 5, "color": 6, "tone": 1, "base": 3, "longitude": 170.0},
        ],
        design_activations=[
            {"planet": "sun", "gate": 43, "line": 6, "color": 1, "tone": 4, "base": 2, "longitude": 12.0},
            {"planet": "earth", "gate": 23, "line": 6, "color": 4, "tone": 2, "base": 5, "longitude": 192.0},
            {"planet": "north_node", "gate": 34, "line": 1, "color": 5, "tone": 4, "base": 1, "longitude": 155.0},
            {"planet": "south_node", "gate": 20, "line": 1, "color": 2, "tone": 6, "base": 3, "longitude": 335.0},
            {"planet": "moon", "gate": 57, "line": 3, "color": 3, "tone": 1, "base": 4, "longitude": 265.0},
            {"planet": "mercury", "gate": 10, "line": 5, "color": 6, "tone": 5, "base": 2, "longitude": 205.0},
            {"planet": "venus", "gate": 25, "line": 2, "color": 1, "tone": 3, "base": 1, "longitude": 10.0},
            {"planet": "mars", "gate": 51, "line": 4, "color": 4, "tone": 2, "base": 5, "longitude": 5.0},
            {"planet": "jupiter", "gate": 42, "line": 3, "color": 2, "tone": 6, "base": 3, "longitude": 340.0},
            {"planet": "saturn", "gate": 3, "line": 1, "color": 5, "tone": 1, "base": 4, "longitude": 350.0},
            {"planet": "uranus", "gate": 27, "line": 6, "color": 3, "tone": 4, "base": 2, "longitude": 35.0},
            {"planet": "neptune", "gate": 22, "line": 2, "color": 1, "tone": 5, "base": 1, "longitude": 320.0},
            {"planet": "pluto", "gate": 36, "line": 4, "color": 6, "tone": 3, "base": 5, "longitude": 315.0},
        ],
...
def _make_reflector_output() -> CalculatorOutput:
    ...
    return CalculatorOutput(
        ...
        active_channels=[],
        variables={
            "digestion":   {"arrow": "Right", "color": 5, "tone": 3},
            "environment": {"arrow": "Left",  "color": 1, "tone": 2},
            "motivation":  {"arrow": "Right", "color": 1, "tone": 4},
            "perspective": {"arrow": "Left",  "color": 1, "tone": 6},
        },
        personality_activations=[
            {"planet": "sun", "gate": 1, "line": 5, "color": 3, "tone": 2, "base": 1, "longitude": 250.0},
            {"planet": "earth", "gate": 2, "line": 5, "color": 4, "tone": 1, "base": 3, "longitude": 70.0},
        ],
        design_activations=[
            {"planet": "sun", "gate": 7, "line": 1, "color": 1, "tone": 4, "base": 2, "longitude": 110.0},
            {"planet": "earth", "gate": 13, "line": 1, "color": 2, "tone": 5, "base": 4, "longitude": 290.0},
        ],
        design_utc=datetime(1990, 7, 10, 12, 0, tzinfo=timezone.utc),
